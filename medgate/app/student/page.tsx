      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8 animate-fade-in">
          <div>
            ...
            <p className="text-slate-300">Learn about MedGate and apply for programs</p>
          </div>
        ...
        <div className="mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="flex space-x-1 bg-white/5 backdrop-blur-xl p-1 rounded-xl shadow-sm border border-white/10">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
          {activeTab === 'about' && (
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-lg p-8">
              <h2 className="text-2xl font-bold text-slate-100 mb-6">About MedGate</h2>
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                    <h3 className="text-xl font-semibold text-slate-100 mb-4">Our Commitment</h3>
                    <ul className="space-y-3 text-slate-300">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-cyan-400 mr-3 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-6">
                    <h3 className="text-xl font-semibold text-slate-100 mb-4">Why Choose MedGate?</h3>
                    <ul className="space-y-3 text-slate-300">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
          ...
          {activeTab === 'mission' && (
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-lg p-8">
              <h2 className="text-2xl font-bold text-slate-100 mb-6">Mission & Vision</h2>
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 border border-cyan-400/20 p-8 rounded-xl">
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-300 to-indigo-300 bg-clip-text text-transparent mb-4">Our Mission</h3>
                  <p className="text-lg text-slate-300 leading-relaxed">
                ...
                <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-400/20 p-8 rounded-xl">
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-indigo-300 to-purple-300 bg-clip-text text-transparent mb-4">Our Vision</h3>
                  <p className="text-lg text-slate-300 leading-relaxed">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center rounded-lg border border-white/10 bg-white/5 p-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-cyan-500/20 to-cyan-500/5 rounded-full flex items-center justify-center mx-auto mb-4 border border-cyan-400/20">
                      <svg className="w-8 h-8 text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
                    <h4 className="font-semibold text-slate-100 mb-2">Education</h4>
                    <p className="text-slate-400 text-sm">Providing world-class medical education accessible to all</p>
                  </div>
                  <div className="text-center rounded-lg border border-white/10 bg-white/5 p-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-indigo-500/20 to-indigo-500/5 rounded-full flex items-center justify-center mx-auto mb-4 border border-indigo-400/20">
                    ...
                    <p className="text-slate-400 text-sm">Advancing healthcare education through technology</p>
                  </div>
                  <div className="text-center rounded-lg border border-white/10 bg-white/5 p-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-500/20 to-purple-500/5 rounded-full flex items-center justify-center mx-auto mb-4 border border-purple-400/20">
                    ...
                    <p className="text-slate-400 text-sm">Building a global network of healthcare professionals</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'apply' && (
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-lg p-8">
              <h2 className="text-2xl font-bold text-slate-100 mb-6">Apply for Programs</h2>
              <div className="text-center py-12">
                <div className="w-24 h-24 bg-gradient-to-br from-cyan-500/20 to-cyan-500/5 rounded-full flex items-center justify-center mx-auto mb-6 border border-cyan-400/20">
                  <svg className="w-12 h-12 text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-slate-100 mb-4">Ready to Start Your Medical Journey?</h3>
                ...
                <div className="mt-8 p-6 rounded-xl border border-amber-400/30 bg-gradient-to-r from-amber-500/10 to-orange-500/10">
                  <div className="flex items-start">
                    <svg className="w-6 h-6 text-amber-300 mr-3 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    <div className="text-left">
                      <h4 className="font-semibold text-amber-200 mb-2">Application Requirements</h4>
