      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-2">
            ...
            <Link href="/purpose-focus" className="text-slate-300 hover:text-cyan-300 transition-colors font-medium text-sm px-3 py-2 rounded hover:bg-white/5">
              Purpose + Focus
            </Link>
        ...
        {mobileMenuOpen && (
          <nav className="lg:hidden mt-4 pb-4 space-y-2 border-t border-white/10 pt-4">
            ...
            <Link href="/purpose-focus" className="block text-slate-300 hover:text-cyan-300 transition-colors font-medium px-3 py-2 rounded hover:bg-white/5">
              Purpose + Focus
            </Link>
